...
[task_local]
#汪汪乐园养joy
40 0-23/6 * * * jd_joypark_joy.js, tag=汪汪乐园养joy, img-url=https://raw.githubusercontent.com/tsukasa007/icon/master/jd_joypark_joy.png, enabled=true

================Loon==============
[Script]
cron "40 0-23/6 * * *" script-path=jd_joypark_joy.js,tag=汪汪乐园养joy

===============Surge=================
汪汪乐园养joy = type=cron,cronexp="40 0-23/6 * * *",wake-system=1,timeout=3600,script-path=jd_joypark_joy.js

============小火箭=========
汪汪乐园养joy = type=cron,script-path=jd_joypark_joy.js, cronexpr="40 0-23/6 * * *", timeout=3600, enable=true
*/
...
function getShareCode() {
  return new Promise(resolve => {
      $.get({
          url: "https://raw.githubusercontent.com/TongLin138/Test/main/utils/empty.json",
          headers: {
